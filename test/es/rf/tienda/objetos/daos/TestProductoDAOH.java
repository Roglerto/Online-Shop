...
import es.rf.tienda.objetos.daos.Hibernate.ProductoDAOH;

public class TestProductoDAOH {

	static ProductoDAOH pDAOH;
	...
	public void insertProducto(){
		try {
			int num=pDAOH.insertarRegistro(prod1);
